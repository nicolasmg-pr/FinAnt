...
export const es: Translations = {
  ...
  backup: {
    ...
    subtitle:
      'Una copia cifrada de todo lo que hay en FinAnt, en un archivo que guardas tú. Tu teléfono es el único sitio donde existen estos datos: una copia de seguridad es la única manera de sobrevivir a perderlo.',
    lastBackup: 'Última copia de seguridad: {{date}}',
    never: 'Todavía no has hecho ninguna copia de seguridad.',
    create: 'Crear copia de seguridad',
    creating: 'Preparando tu copia de seguridad…',
    codeTitle: 'Tu código de recuperación',
    codeBody:
      'Apúntalo ahora o guárdalo en tu gestor de contraseñas. Es lo único que abre la copia de seguridad, FinAnt no guarda una copia del código, y sin él el archivo no vale nada.',
    codeCopied: 'Copiado.',
    codeConfirm: 'He guardado este código',
    share: 'Guardar el archivo',
    restore: 'Restaurar desde una copia de seguridad',
    pickFile: 'Elige un archivo de copia de seguridad',
    enterCode: 'Código de recuperación',
    enterCodeHint: 'El código que se mostró al hacer la copia.',
    previewTitle: 'Esta copia de seguridad',
    previewMade: 'Hecha el {{date}} con FinAnt {{version}}',
    previewRows: '{{count}} fila',
    ...
    errorSchemaMismatch:
      'Esa copia de seguridad no corresponde a esta versión de FinAnt. No se ha cambiado nada.',
  ...
  portfolio: {
    title: 'Cartera',
    empty: 'Aún no hay inversiones. Importa un extracto de bróker que liste sus operaciones.',
    value: 'Valor',
    invested: 'Invertido',
    unrealised: 'No realizado',
    realised: 'Realizado',
    dividends: 'Dividendos',
    benefits: 'Recompensas',
    fees: 'Comisiones',
    totalReturn: 'Rentabilidad total',
    holdings: 'Posiciones',
    closed: 'Posiciones cerradas',
    shares: '{{count}} participaciones',
    avgCost: 'Medio {{amount}}',
    price: 'Ahora {{amount}}',
    allocation: 'Distribución',
    byAsset: 'Por posición',
    byClass: 'Por tipo',
    refresh: 'Actualizar precios',
    refreshing: 'Obteniendo precios…',
    asOf: 'Precios a {{time}}',
    never: 'Precios nunca obtenidos',
    offline: 'No se pudo contactar con el servicio de precios. Se muestran los últimos guardados.',
    unpriced: '{{count}} posición(es) sin precio utilizable quedan fuera del total.',
    oversold: 'Se vendió más de lo que reflejan las importaciones. Falta una compra.',
    manualPrice: 'Tu precio',
    setManualPrice: 'Poner un precio a mano',
    clearManualPrice: 'Usar precios obtenidos',
    priceHint:
      'Un precio que escribas aquí siempre manda, y su símbolo no se envía a ningún sitio.',
    rename: 'Renombrar posición',
    privacy: 'Solo se envían los símbolos que tienes, y solo cuando actualizas.',
    assetClass: { fund: 'Fondos y ETF', stock: 'Acciones', crypto: 'Cripto' },
  },
  categories: {
    title: 'Categorías',
  ...
  category: {
    ...
    'investment-trade': 'Operación de inversión',
