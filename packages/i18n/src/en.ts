...
export const en = {
  ...
  backup: {
    ...
    tables: {
      ...
      import_profiles: 'Import formats',
      rules: 'Classification rules',
      budgets: 'Budgets',
      exclusion_rules: 'Automatic exclusions',
      transactions: 'Movements',
      assets: 'Holdings',
      investment_legs: 'Trades',
      quotes: 'Current prices',
      price_history: 'Price history',
      notification_sources: 'Bank notifications',
      notification_routes: 'Notification rules',
      settings: 'Settings',
    },
  },
  budgets: {
  ...
  portfolio: {
    title: 'Portfolio',
    empty: 'No investments yet. Import a broker statement that lists its trades.',
    value: 'Value',
    invested: 'Invested',
    ...
    never: 'Prices never fetched',
    offline: 'Could not reach the price service. Showing the last prices saved.',
    unpriced: '{{count}} holding(s) have no usable price and are not in the total.',
    oversold: 'More was sold than the imports account for. A purchase is missing.',
    manualPrice: 'Your price',
    setManualPrice: 'Set a price by hand',
    clearManualPrice: 'Use fetched prices',
    priceHint: 'A price you type here always wins, and its symbol is never sent anywhere.',
    rename: 'Rename holding',
    privacy: 'Only the symbols you hold are sent, and only when you refresh.',
    assetClass: { fund: 'Funds & ETFs', stock: 'Shares', crypto: 'Crypto' },
  },
  categories: {
    title: 'Categories',
